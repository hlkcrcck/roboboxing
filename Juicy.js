...
Phaser.Plugin.Juicy.prototype.jelly = function(object, strength, delay, initialScale) {
  ...
  this.game.add.tween(object.scale).to({x: initialScale + (initialScale * strength)}, 50, Phaser.Easing.Quadratic.InOut, true, delay)
  .to({x: initialScale}, 600, Phaser.Easing.Elastic.Out, true);

  this.game.add.tween(object.scale).to({y: initialScale + (initialScale * strength)}, 50, Phaser.Easing.Quadratic.InOut, true, delay + 50)
  .to({y: initialScale}, 600, Phaser.Easing.Elastic.Out, true);
};
